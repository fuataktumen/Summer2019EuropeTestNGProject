...
public class TestCases4_26122019 extends TestBase {
    @Test
...
@Test
    ...
    String startstr=ccsp.startTime.getAttribute("value");
    String endstr=ccsp.endTime.getAttribute("value");
    int start=Integer.parseInt(startstr.substring(0,1).concat(startstr.substring(2,4)));
    int end =Integer.parseInt(endstr.substring(0,1).concat(endstr.substring(2,4)));
    extentLogger.info("Verify that difference end and start is 1 hour");
    Assert.assertTrue((end-start==100),"Verify that difference end and start is 1 hour");
    extentLogger.pass("PASS: TestCaseFour5: Verify that difference end and start is 1 hour");
